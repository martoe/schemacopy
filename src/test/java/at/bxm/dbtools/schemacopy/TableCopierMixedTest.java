...
public class TableCopierMixedTest extends TestBase {
	...
	@Test
	public void copyLobFromOracleToH2_reuse() {
		...
		tc.copy(Oracle.LOBTABLE_NAME, null, null, null, CopyTargetMode.REUSE);
	...
	@Test
	public void copyLobFromOracleToH2_create() {
		...
		// WHEN: copying
		TableCopier tc = new TableCopier(sourceDb, targetDb);
		tc.copy(Oracle.LOBTABLE_NAME, null, null, null, CopyTargetMode.CREATE);
	...
	@Test
	public void copyLobFromH2ToOracle_reuse() {
	...
	@Test
	public void copyLobFromH2ToOracle_create() {
